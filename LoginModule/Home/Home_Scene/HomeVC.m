...
//    
    ...
    cell.homeTopRatedRecipeName.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.5];
    ...
    cell.homeTopRatedRecipeDesc.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.5];
    ...
    cell.homeTopRatedRecipeDesc.textColor = [UIColor redColor];
    ...
    cell.homeCookingTime.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.4];
    ...
    cell.homeCookingTime.textColor = [UIColor redColor];
    ...
    cell.homeServes.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.4];
    ...
    cell.homeServes.textColor = [UIColor redColor];
...
#pragma mark -push to sidebar controller
