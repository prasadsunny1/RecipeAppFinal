...
- (void)commonInitialization {
    ...
    self.activeColor = [UIColor colorWithRed:0.5451 green: 0.0 blue:0.0 alpha:1.0];
    self.inactiveColor = [UIColor colorWithRed:0.5451 green: 0.0 blue:0.0 alpha:1.0];
    self.seperatorColor = [UIColor colorWithRed:0.5451 green: 0.0 blue:0.0 alpha:1.0];
    self.borderLayer.borderColor = self.seperatorColor.CGColor;
    self.titleViewColor = [UIColor whiteColor];
    self.titleLabel.font = [UIFont fontWithName:@"Cochin-Italic" size:25.0f];
